...
con = openeo.connect(backend_url).authenticate_basic('test', 'test')
...
datacube = datacube.filter_bbox(
    west=11.279182, south=46.464349, east=11.406898, north=46.522729)
datacube = datacube.filter_temporal(
    extent=["2018-05-01T00:00:00Z", "2018-10-10T23:59:59Z"])
